...
|------|------:|------:|
| **Orbits** | *Scene resembling a Solar System* 
...
| **Rolling Character** | *Following Catlikecoding.com tutorial on Movement*
The tutorial mainly focuses on a Third Person Controller that follows a Sphere with drag coefficient of 0, it shows some examples on how to implement some behaviors like sliding, rolling, jumping, climbing, swimming, etc. I am currently working on taking some ideas from this Tutorial and applying them to my current Spring-Based Character controller.
More detailed explanation on: /docs/rollingCharacter.md | <img src="Docs/Img/Rolling-Character-Controller-Thumbnail.PNG" width="420" alt="Rolling Character"> |
